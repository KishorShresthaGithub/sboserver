...
var titleSlug = function titleSlug(ev, options) {
  ev.slug = (0, _slugify["default"])(ev.title, {
    replacement: "-",
    lower: true
  });
  ev.slug += "-".concat((0, _cryptoRandomString["default"])({
    length: 5
  }));
...
Event.beforeUpdate(titleSlug); //Event.sync({ force: true });
