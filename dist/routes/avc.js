...
router.put("/:id", _authenticate_token["default"], _avcenter.updateValidation, _validation.validationMid, _avccontroller["default"].update);
router["delete"]("/:id", _authenticate_token["default"], _avccontroller["default"].destroy);
var _default = router;
