...
router.put("/:id", _authenticate_token["default"], _upload.imageUpload.single("image"), _snake.updateValidation, _validation.validationMid, _snakecontroller["default"].update);
router["delete"]("/:id", _authenticate_token["default"], _snakecontroller["default"].destroy);
var _default = router;
