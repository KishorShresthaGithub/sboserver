...
var createValidation = [(0, _expressValidator.check)("title").notEmpty().withMessage("Title should not be empty").trim(), (0, _expressValidator.check)("description").notEmpty().withMessage("Description should not be empty")];
