...
router.put("/:slug", _authenticate_token["default"], _upload.imageUpload.single("image"), _slider.updateValidation, _validation.validationMid, _Slidercontroller["default"].update);
router["delete"]("/:slug", _authenticate_token["default"], _Slidercontroller["default"].destroy);
var _default = router;
