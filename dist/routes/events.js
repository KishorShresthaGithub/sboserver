...
router.get("/upcoming", _eventcontroller["default"].upcoming);
...
router.put("/:id", _authenticate_token["default"], _upload.imageUpload.single("image"), _events.updateValidation, _validation.validationMid, _eventcontroller["default"].update);
router["delete"]("/:id", _authenticate_token["default"], _eventcontroller["default"].destroy);
var _default = router;
