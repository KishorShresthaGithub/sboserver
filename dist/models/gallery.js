...
var _galleryimage = _interopRequireDefault(require("./galleryimage"));
...
var Gallery = /*#__PURE__*/function (_Model) {
  _inherits(Gallery, _Model);
...
var slugTitle = function slugTitle(model, options) {
  return model.slug = (0, _slugify["default"])(model.title, {
    replacement: "-",
    lower: true
  });
};
...
Gallery.hasMany(_galleryimage["default"], {
