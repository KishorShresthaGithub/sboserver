...
router.post("/", _authenticate_token["default"], _upload.imageUpload.single("image"), _eventcontroller["default"].save);
router.put("/:slug", _authenticate_token["default"], _upload.imageUpload.single("image"), _eventcontroller["default"].update);
