        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 6;
              return _gallery["default"].findAll(_objectSpread({
                include: [{
      ...
      return regeneratorRuntime.wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 6:
              if (!_uploadcontroller["default"].unlinkUrl(galleryImage.image)) console.log(galleryImage.image + " File not deleted");
