              ...
              switch ((_context.prev = _context.next)) {
                ...
                case 3:
                  ...
                  return _context.abrupt(
                    "return",
                    _basecontroller["default"].sendResponse(
                      res,
                      users,
                      "Users Listing"
                    )
                ...
                case 7:
                  ...
                  return _context.abrupt(
                    "return",
                    _basecontroller["default"].sendError(res, _context.t0)
                  );
            ...
            while (1) {
              switch ((_context2.prev = _context2.next)) {
                ...
                case 8:
                  ...
                  return _context2.abrupt(
                    "return",
                    _basecontroller["default"].sendError(res, _context2.t0)
                  );
            ...
            while (1) {
              switch ((_context3.prev = _context3.next)) {
                ...
                case 7:
                  ...
                  return _context3.abrupt(
                    "return",
                    _basecontroller["default"].sendError(res, _context3.t0)
                  );
  ...
  updateUser: function updateUser(req, res, next) {
    return _asyncToGenerator(
      /*#__PURE__*/ regeneratorRuntime.mark(function _callee4() {
        var user_string_id, _req$body, role, request, user, update;
            ...
            while (1) {
              switch ((_context4.prev = _context4.next)) {
                case 0:
                  ...
                  user_string_id =
                    req.params.user_string_id || req.user.string_id; //TODO handle request body empty in validation
                  //TODO handle email uniqueness when update
                  //getting request except role

                  (_req$body = req.body),
                    (role = _req$body.role),
                    (request = _objectWithoutProperties(_req$body, _excluded)); //find user
                ...
                case 5:
                  ...
                  return _context4.abrupt(
                    "return",
                    _basecontroller["default"].sendError(
                      res,
                      {},
                      "User does not exist",
                      400
